...
Live: [desk](https://pam-wallet.onrender.com/) · [exam](https://pam-wallet.onrender.com/#/exam) · [recon](https://pam-wallet.onrender.com/#/exam-recon) · [RG](https://pam-wallet.onrender.com/#/exam-rg) · [drill](https://pam-wallet.onrender.com/#/drill)
...
Open **http://127.0.0.1:5173** — desk. Exam 1–5: **#/exam**. Recon: **#/exam-recon**. RG: **#/exam-rg**. Spot-the-slip gym: **#/drill**.

Production (one process, after `npm run build` at this folder): **http://127.0.0.1:3001**, **#/exam**, **#/exam-recon**, **#/exam-rg**, **#/drill**. Nest serves `web/dist`.
...
RG: `GET /api/quiz/rg` · `POST /api/quiz/rg/check` · `POST /api/quiz/rg/grade`. **8** questions.  
